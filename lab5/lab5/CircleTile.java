...
static
{
	...
	public CircleTile(int rank)
	{
		...
		case 1:
			...
			//System.out.println(smallPolygonWidth*2+(wid/2));
			System.out.println( (tileWidth));
			////diameter is that of small circle
		  ...
		  case 4: 
			  Circle fourA= new Circle( xFor2, xFor2+valFor2 , Color.green, diameter,true);
				Circle fourB= new Circle(xFor2+valFor2,(tileWidth/3)-radius  , Color.green, diameter,true);
				Circle fourC= new Circle(xFor2, (tileWidth/3)-radius, Color.blue, diameter,true);
		  ...
		  case 2:
			Circle twoA= new Circle(smallPolygonWidth*2+(tileWidth/2), (tileWidth/3)-radius, Color.blue, diameter,true);
		  ...
		  case 5: //top left
				...
				Circle fiveB= new Circle((smallPolygonWidth*2)+quarterOfTileWidth, 3*quarterOfTileWidth, Color.blue, diameter,true);
				circles.add(fiveA);
				circles.add(fiveB);
		  ...
		  case 6: //top left 
			  ...
			  Circle sixA= new Circle((smallPolygonWidth*2)+quarterOfTileWidth,  quarterOfTileWidth, Color.green, diameter,true);
				Circle sixB= new Circle((smallPolygonWidth*2)+(quarterOfTileWidth),2* quarterOfTileWidth,Color.red, diameter,true); 
				Circle sixC= new Circle((smallPolygonWidth*2)+quarterOfTileWidth, 3*quarterOfTileWidth, Color.red, diameter,true);
				
				  Circle sixD= new Circle((smallPolygonWidth*2)+(3*quarterOfTileWidth), quarterOfTileWidth,Color.green, diameter,true);
					Circle sixE= new Circle((smallPolygonWidth*2)+(3*quarterOfTileWidth),2*quarterOfTileWidth, Color.red, diameter,true);
					Circle sixF= new Circle((smallPolygonWidth*2)+(3*quarterOfTileWidth), 3*quarterOfTileWidth, Color.red, diameter,true);
					circles.add(sixA);
					circles.add(sixB);
					circles.add(sixC);
		  ...
		  case 8: //top left
			  	...
			  	Circle circle1= new Circle((smallPolygonWidth*2)+y4, y4, Color.blue, diameter,true); 
				Circle circle2= new Circle((smallPolygonWidth*2)+y4, 2*y4, Color.blue, diameter,true); 
				Circle circle3= new Circle((smallPolygonWidth*2)+y4, 3*y4, Color.blue, diameter,true);
				 Circle circle4= new Circle((smallPolygonWidth*2)+y4, 4*y4, Color.blue, diameter,true);
				 
				 
					Circle circle5= new Circle((smallPolygonWidth*2)+(3*y4), 4*y4, Color.blue, diameter,true);  
					Circle circle6= new Circle((smallPolygonWidth*2)+(3*y4), y4, Color.blue, diameter,true);
					Circle circle7= new Circle((smallPolygonWidth*2)+(3*y4), 2*y4, Color.blue, diameter,true);
					Circle circle8= new Circle((smallPolygonWidth*2)+(3*y4), 3*y4, Color.blue, diameter,true);
					circles.add(circle1);
					circles.add(circle2);
					circles.add(circle3);
		...
		//  
		  case 9: //top left
			  ...
			  Circle nineA= new Circle((smallPolygonWidth*2)+quarterOfTileWidth-radius, quarterOfTileWidth, Color.blue, diameter,true);
				Circle nineB= new Circle((smallPolygonWidth*2)+quarterOfTileWidth-radius, 2*quarterOfTileWidth,Color.red, diameter,true);
				Circle nineC= new Circle((smallPolygonWidth*2)+quarterOfTileWidth-radius, 3*quarterOfTileWidth, Color.green, diameter,true);
				 Circle nineD= new Circle((smallPolygonWidth*2)+(2*quarterOfTileWidth)-radius, quarterOfTileWidth, Color.blue, diameter,true);
				 
				 
					Circle nineE= new Circle((smallPolygonWidth*2)+(2*quarterOfTileWidth)-radius, 2*quarterOfTileWidth, Color.red, diameter,true); 
					Circle nineF= new Circle((smallPolygonWidth*2)+(2*quarterOfTileWidth)-radius,3*quarterOfTileWidth, Color.green, diameter,true);
					Circle nineG= new Circle((smallPolygonWidth*2)+(3*quarterOfTileWidth)-radius,  quarterOfTileWidth, Color.blue, diameter,true);
					Circle nineH= new Circle((smallPolygonWidth*2)+(3*quarterOfTileWidth)-radius,2*quarterOfTileWidth, Color.red, diameter,true);
					Circle nineI= new Circle((smallPolygonWidth*2)+(3*quarterOfTileWidth)-radius, 3*quarterOfTileWidth, Color.green, diameter,true); 
					circles.add(nineA);
					circles.add(nineB);
					circles.add(nineC);
	...
	public void drawCircles(Graphics g, int rank)
	{
		...
		case 7:  
			...
			g.fillOval(x7u+(2*valueOfX), 3*y7u, diameter, diameter);
				...
				//  g.fillOval((side*2)+(3*y4), 4*y4, diameter, diameter);

 ...
 * 
 * 
 * tiles.add(new CharacterTile('1')); tiles.add(new CharacterTile('2'));
 * tiles.add(new CharacterTile('3')); tiles.add(new CharacterTile('4'));
 * tiles.add(new CharacterTile('5')); tiles.add(new CharacterTile('6'));
 * tiles.add(new CharacterTile('7')); tiles.add(new CharacterTile('8'));
 * tiles.add(new CharacterTile('9')); tiles.add(new CharacterTile('N'));
 * tiles.add(new CharacterTile('E')); tiles.add(new CharacterTile('W'));
 * tiles.add(new CharacterTile('S')); tiles.add(new CharacterTile('C'));
